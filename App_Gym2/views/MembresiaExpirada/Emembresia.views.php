...
?>
    ...
    <body id="page-top">
                ...
                <div class="modal-content">
                    ...
                    <form id="Membresia_form">
                        <div class="modal-body">
                            <input name="men_id" id="men_id" hidden>
                            ...
                            <div class="form-group">
                                ...
                                <select name="men_estado" id="men_estado" class="form-control" required>
        ...
        <script>
            // Obtén una referencia al elemento select y al botón Guardar
            const estadoSelect = document.getElementById('men_estado');
            ...
            estadoSelect.addEventListener('change', function() {
                ...
                if (estadoSelect.value === 'Activo') {
                    // Si está seleccionado "Activo", habilita el botón
                    guardarButton.removeAttribute('disabled');
                } else {
                    // Si está seleccionado "Expirado" u otra opción, deshabilita el botón
        ...
        <script>
            function busqueda() {
                ...
                xmlhttp.open("GET", "Emembresia.busqueda.php?buscar=" + buscar, true);
                xmlhttp.send();
            }
        </script>
        <script>
