...
$query = "SELECT 	men_id, cli_cedula, tipo_menbresia, men_fecha_inicio, men_fecha_fin, men_estado 
          ...
          WHERE (cliente.cli_cedula LIKE '%$buscar%' OR tipo_menbresia.tipo_menbresia LIKE '%$buscar%') AND men_estado='Activo'";
...
echo "<td>" . calcularTiempoRestante($row['men_fecha_fin']) . "</td>"; // Agrega el tiempo restante
echo "<td>" . $row['men_estado'] . "</td>";
echo "<td>";
echo "<button class='btn btn-success' onclick='uno(" . $row['men_id'] . ")'>Editar</button>";
